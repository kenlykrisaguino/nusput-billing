    ...
    <form method="get" class="grid md:grid-cols-3 gap-4">
        ...
        <div class="md:col-span-3">
            ...
            <button type="button" id="reset-filter"
                class="cursor-pointer px-4 py-1 text-sm bg-red-500 text-white rounded hover:bg-red-700">Reset
                Filter</button>
        </div>
    </form>
        ...
        <div class="mt-8 relative flex flex-col gap-2 justify-center sm:rounded-lg">
            <table class="text-sm text-left w-full md:w-100">
                <thead class="border-b border-slate-400">
                    <tr>
                        <th colspan="2"
                            class="uppercase text-center px-6 py-4 bg-white text-slate-700 whitespace-nowrap">Penerbitan
                            Uang Sekolah</th>
                    </tr>
                </thead>
                <tbody class="border-b border-slate-400">
                    <tr class="border-b w-[100%] border-slate-200">
                        ...
                        <th scope="row"
                            class="px-6 py-4 font-medium bg-white text-slate-700 whitespace-nowrap font-semibold">
                            <?= FormatHelper::formatRupiah($per_first_day) ?>
                        </th>
                    </tr>
                    <tr class="border-b w-[100%] border-slate-200">
                        <th scope="row"
                            class="text-right px-6 py-4 font-medium bg-white text-slate-700 whitespace-nowrap font-semibold">
        ...
        <div class="mt-8 relative flex flex-col gap-2 justify-center sm:rounded-lg">
            <table class="text-sm text-left w-full md:w-100">
                <thead class="border-b border-slate-400">
                    <tr>
                        <th colspan="2"
                            class="uppercase text-center px-6 py-4 bg-white text-slate-700 whitespace-nowrap">Pelunasan
                            Uang Sekolah</th>
                    </tr>
                </thead>
                <tbody class="border-b border-slate-400">
        ...
        <div class="mt-8 relative flex flex-col gap-2 justify-center sm:rounded-lg">
            <table class="text-sm text-left w-full md:w-100">
                <thead class="border-b border-slate-400">
                    <tr>
                        <th colspan="2"
                            class="uppercase text-center px-6 py-4 bg-white text-slate-700 whitespace-nowrap">
                            Penerbitan Denda</th>
                    </tr>
                </thead>
                <tbody class="border-b border-slate-400">
