...
$data = $app->StudentBE()->studentPage();
        ...
        <div class="bg-slate-50 p-4 rounded-xl mt-2 relative overflow-x-auto shadow-md sm:rounded-lg">
            <div class="w-full grid grid-cols-1 sm:grid-cols-2 gap-y-2 md:grid-cols-3 lg:grid-cols-4">
                ...
                <div>
                    ...
                    <div class="text-lg text-slate-800 font-medium"><?= $dashboard['nama'] ?? '-' ?></div>
                </div>
                <div>
                    <div class="text-xs text-blue-500 font-bold uppercase">Kontak Orang Tua</div>
                    <div class="text-lg text-slate-800 font-medium"><?= $dashboard['no_hp_ortu'] ?? '-' ?></div>
                </div>
                <div>
                ...
                <div>
                    ...
                    <div class="text-lg text-slate-800 font-medium">
                        <?= FormatHelper::formatRupiah($dashboard['spp'] ?? 0) ?>
                    </div>
                </div>
                <div>
                    <div class="text-xs text-blue-500 font-bold uppercase">Pembayaran Terakhir</div>
                    <div class="text-lg text-slate-800 font-medium">
                        <?= Call::date($dashboard['latest_payment']) ?? '-' ?></div>
                </div>
                <div>
            ...
            <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
                <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                    ...
                    <tbody>
                        ...
                        <tr class="<?= $payment['status'] ? "text-green-500" : "text-red-500" ?> bg-white cursor-pointer hover:bg-slate-200 transition-all border-b border-gray-200">
                            <th scope="row" class="px-6 py-4 font-medium whitespace-nowrap flex flex-col gap-2">
                                <div><?= $payment['bulan'] ?></div>
                            </th>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <?= FormatHelper::formatRupiah($payment['tagihan']) ?>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
