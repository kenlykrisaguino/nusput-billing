<div class="w-full">
    <div class="flex justify-between w-full mb-2">
        ...
        <div class="flex gap-2">
            <div class="px-2 py-1 text-xs rounded-md border border-blue-700 text-blue-500 hover:text-blue-800 cursor-pointer font-semibold">Tambah Siswa</div>
            ...
            <form action="" method="get">
                ...
                <div class="relative">
                    ...
                    <input type="search" id="search" name="search" value="<?= $_GET['search'] ?? '' ?>" class="block w-full px-2 py-1 ps-7 text-xs rounded-md text-blue-900 border border-blue-700 rounded-lg focus:ring-blue-500 focus:border-blue-500" placeholder="Search Students" />
                ...
                <?php if (count($students) > 0) : ?>
                    ...
                    <tr class="odd:bg-white even:bg-gray-50 border-b border-gray-200">
                        <td class="px-6 py-4 flex gap-2">
                            <i class="fa-solid fa-pencil cursor-pointer hover:text-blue-300 transition-colors" onclick="editStudent(<?= $student['virtual_account'] ?>"></i>
                        </td>
