<div id="filter-journal-modal" class="hidden fixed inset-0 bg-gray-600 bg-opacity-75 overflow-y-auto h-full w-full z-[100]">
    <div class="relative top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 p-6 border w-11/12 md:w-1/2 lg:w-1/3 max-w-lg shadow-xl rounded-lg bg-white">
        ...
        <div class="flex justify-between items-center pb-3 border-b border-gray-200">
            <h3 class="text-xl font-semibold text-gray-800">Filter Laporan Keuangan</h3>
            <button onclick="document.getElementById('filter-journal-modal').classList.add('hidden')" class="text-gray-400 hover:text-gray-600 transition-colors">
        ...
        <div class="my-6">
            <form id="filter-journal-form">
                <div class="space-y-5">
                    <div>
                        <label for="filter-siswa" class="block text-sm font-medium text-gray-700">Siswa</label>
                        <select name="filter-siswa" id="filter-siswa" class="mt-1 block w-full px-3 py-2 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-sky-500 focus:border-sky-500 sm:text-sm">
                    ...
                    <div class="flex flex-col sm:flex-row gap-2 w-full justify-between">
                        ...
                        <div class="flex-1">
                            ...
                            <select name="filter-bulan" id="filter-bulan" class="mt-1 block w-full px-3 py-2 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-sky-500 focus:border-sky-500 sm:text-sm">
