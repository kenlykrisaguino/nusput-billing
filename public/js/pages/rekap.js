...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const filterModal = document.getElementById("filter-recap");
  if (filterModal) {
    const levelSelectFilter = filterModal.querySelector("#level-filter");
    const gradeSelectFilter = filterModal.querySelector("#grade-filter");
    const sectionSelectFilter =
      filterModal.querySelector("#section-filter");
    ...
    const yearSelect = filterModal.querySelector("#year-filter");
    const semesterSelect = document.querySelector("#semester-filter");
    const monthSelect = filterModal.querySelector("#month-filter");
